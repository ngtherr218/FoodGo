...
import com.example.orderfoodbtl.Adapter.FavoriteAdapter;
...
public class FavoriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<Product> listFavorite = databaseHelper.getAllProductsFromFavorite(userID);
        favoriteAdapter = new FavoriteAdapter(getContext(),listFavorite);
